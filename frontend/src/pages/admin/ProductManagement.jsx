...
const ProductManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Filter out empty image URLs before sending to the database
      const productData = {
        ...formData,
    ...
    <AdminLayout>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-gray-600 bg-opacity-50">
          <div className="flex min-h-screen items-start md:items-center justify-center px-4 py-6">
            <div className="relative w-full max-w-5xl my-8 bg-white rounded-lg shadow-xl p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-base sm:text-sm"
                      required
                    >
